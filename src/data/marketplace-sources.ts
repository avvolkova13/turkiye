...
export const sourceProducts: SourceProduct[] = [
  ...
  { id: "trasst-esim-1gb", title: "eSIM Турция: 1 ГБ", description: "Небольшой пакет для мессенджеров и навигации с активацией по QR-коду.", section: "eSIM", type: "connectivity", sourcePrice: 0.99, priceUnit: "за пакет", sourceUrl: trasst, imagePath: "/images/esim-turkey-1gb.png", durationMinutes: 10080, isDigital: true },
  { id: "trasst-esim-3gb", title: "eSIM Турция: 3 ГБ", description: "Пакет связи для короткой поездки с инструкцией по установке.", section: "eSIM", type: "connectivity", sourcePrice: 2.29, priceUnit: "за пакет", sourceUrl: trasst, imagePath: "/images/esim-turkey-3gb.png", durationMinutes: 10080, isDigital: true },
  { id: "trasst-esim-10gb", title: "eSIM Турция: 10 ГБ", description: "Универсальный интернет-пакет для города, карт и фотографий.", section: "eSIM", type: "connectivity", sourcePrice: 6.99, priceUnit: "за пакет", sourceUrl: trasst, imagePath: "/images/esim-turkey-10gb.png", durationMinutes: 20160, isDigital: true },
  { id: "trasst-esim-20gb", title: "eSIM Турция: 20 ГБ", description: "Расширенный пакет для длительной поездки и активного использования сети.", section: "eSIM", type: "connectivity", sourcePrice: 12.99, priceUnit: "за пакет", sourceUrl: trasst, imagePath: "/images/esim-turkey-20gb.png", durationMinutes: 30240, isDigital: true },
  { id: "trasst-esim-50gb", title: "eSIM Турция: 50 ГБ", description: "Максимальный пакет для длительного путешествия и раздачи интернета.", section: "eSIM", type: "connectivity", sourcePrice: 28.99, priceUnit: "за пакет", sourceUrl: trasst, imagePath: "/images/esim-turkey-50gb.png", durationMinutes: 43200, isDigital: true },
